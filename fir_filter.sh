...
#
# Script generated by Vivado on Wed May 14 20:00:01 +0530 2025
...
# script info
echo -e "fir_filter.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fir_filter xil_defaultlib.fir_filter xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fir_filter -key {Behavioral:sim_2:Functional:fir_filter} -tclbatch cmd.tcl -log simulate.log
}
